...
const PostSell = (props) =>{
    ...
    return (
        ...
        <Box m="20px" border="3px solid red" borderRadius="8px" maxWidth="100%" padding="5px" style={{color:colors.primary[100] ,background:colors.primary[700]}}>
            <Grid container  direction="row" spacing={2} style={{paddingTop:"1vh" ,}}>       
                ...
                <Grid item xs={12} md={5} align="center" margin="auto" textAlign="center">
                    <Typography variant="h5" ><b style={{ cursor: "pointer"}}>NASDAQ | 20205$ | Stock</b> </Typography>
                </Grid>
            ...
            <Box m="20px" border="1px solid red" borderRadius="8px" maxWidth="100%" padding="5px" >
